...
//   const message =
//     "Hello! Welcome to Ambispine Technologies! Thank you for reaching out to us. How can we assist you today? ";
  ...
  return (
    <div
      style={{
        ...
        bottom: "20px",
        right: "20px",
        background: "linear-gradient(135deg, #00ff99, #0066ff)", // AI-inspired gradient
        borderRadius: "50%",
        padding: "12px",
        cursor: "pointer",
        boxShadow: "0 4px 15px rgba(0, 255, 153, 0.5)",
        zIndex: "1000",
        display: "flex",
      ...
      onMouseOver={(e) => {
        ...
        e.currentTarget.style.boxShadow = "0 6px 20px rgba(0, 255, 153, 0.7)";
      }}
      onMouseOut={(e) => {
        e.currentTarget.style.transform = "scale(1)";
        e.currentTarget.style.boxShadow = "0 4px 15px rgba(0, 255, 153, 0.5)";
      }}
    >
      <BsChatDots size={32} color="#ffffff" />
    </div>
  );
};
