      ...
      >
        <Menu iconshape="square">
          ...
          <Box paddingLeft={collapsed ? undefined : "10%"}>
            ...
            <Item title="View News" to="/news-view" icon={<NewspaperIcon />} selected={selected} setSelected={setSelected} />
            ...
            <Item title="Apllication View" to="/app-view" icon={<WorkOutlineIcon />} selected={selected} setSelected={setSelected} />
            ...
            <Item title ="News Form" to ="/news-form" icon ={<FeedIcon/>}selected={selected} setSelected={setSelected}/>
